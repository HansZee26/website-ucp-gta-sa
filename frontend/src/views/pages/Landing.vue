...
<template>
    <div class="bg-surface-0 dark:bg-surface-900">
        <div id="home" class="landing-wrapper overflow-hidden">
            ...
            <div id="features" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
                <div class="text-center">
                    <div class="text-surface-900 dark:text-surface-0 font-normal mb-2 text-4xl">Features</div>
                    <span class="text-muted-color text-2xl">Berbagai fitur modern yang tersedia di Example Roleplay...</span>
                </div>
                ...
                <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
                    <div class="flex justify-center col-span-12 lg:col-span-6 bg-purple-100 p-0 order-1 lg:order-none" style="border-radius: 8px">
                        <img src="/demo/images/features/gallery1.jpg" class="w-11/12" alt="mockup mobile" />
                    </div>
                    ...
                    <div class="col-span-12 lg:col-span-6 my-auto flex flex-col lg:items-end text-center lg:text-right gap-4">
                        <div class="flex items-center justify-center bg-purple-200 self-center lg:self-end" style="width: 4.2rem; height: 4.2rem; border-radius: 10px">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path fill="currentColor" d="M18 11H6V6h12m-1.5 11a1.5 1.5 0 0 1-1.5-1.5a1.5 1.5 0 0 1 1.5-1.5a1.5 1.5 0 0 1 1.5 1.5a1.5 1.5 0 0 1-1.5 1.5m-9 0A1.5 1.5 0 0 1 6 15.5A1.5 1.5 0 0 1 7.5 14A1.5 1.5 0 0 1 9 15.5A1.5 1.5 0 0 1 7.5 17M4 16c0 .88.39 1.67 1 2.22V20a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1h8v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1.78c.61-.55 1-1.34 1-2.22V6c0-3.5-3.58-4-8-4s-8 .5-8 4z"/></svg>
                        </div>
                        <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">Sidejob Bus Driver</div>
                        <span class="text-surface-700 dark:text-surface-100 text-2xl leading-normal ml-0 md:ml-2" style="max-width: 650px"
                            >Anda dapat bekerja sebagai Driver Bus mengelilingi kota dan berhenti di halte halte di kota untuk mengantarkan penumpang.</span
                        >
                    </div>
                </div>
                ...
                <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
                    <div class="col-span-12 lg:col-span-6 my-auto flex flex-col text-center lg:text-left lg:items-start gap-4">
                        <div class="flex items-center justify-center bg-purple-200 self-center lg:self-start" style="width: 4.2rem; height: 4.2rem; border-radius: 10px">
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64"><g fill="#25333a">
                                <path d="M11.02 53.995C8.984 60.479-.659 57.254.034 56.258c2.161-3.113 11.359-3.449 10.986-2.263m7.902-10.805c10.499-2.959 11.167 7.396 9.354 7.533c-5.707.43-11.275-6.995-9.354-7.533"/><path d="M11.03 53.999c-2.409 6.355 7.165 9.78 7.234 8.565c.229-3.785-6.795-9.731-7.234-8.565"/></g><path fill="#62818e" d="M7.174 35.608c1.585-4.575 7.141-6.797 12.416-4.971c5.281 1.83 8.272 7.01 6.689 11.582c-1.583 4.57-9.758 14.362-15.03 12.541c-5.278-1.83-5.652-14.585-4.072-19.15"/><path fill="#567077" d="M13.204 30.342c-2.806.72-5.101 2.583-6.03 5.267c-1.561 4.51-1.216 16.994 3.88 19.07c-2.655-8.101-2.161-16.953 2.15-24.333"/><path fill="#7094a6" d="M7.664 34.2c-1.103 3.178 2.281 7.23 7.564 9.06c5.275 1.826 10.44.729 11.541-2.445c1.097-3.173-.465-12.484-5.742-14.313c-5.281-1.823-12.268 4.524-13.363 7.702"/><path fill="#25333a" d="m14.04 30.5l1.913-3.478c.016-.057-.028-.129-.109-.198a12 12 0 0 0-1.437.664l-1.041 3c-.093.571-.113 1.021.674.009m3.949 9.107c-1.696-.587-2.674-2.194-2.192-3.587c.49-1.396 2.247-2.052 3.939-1.469c1.692.587 2.669 2.189 2.192 3.591c-.486 1.396-2.247 2.048-3.939 1.465"/><g fill="#929497"><path d="M14.493 9.258c9.09-4.985 23.949-10.02 31.07.634c4.099 6.133 3.615 14.868 3.188 21.883c-.502 8.189-.668 16.484-1.753 24.621c-.306 2.308 3.315 2.279 3.623 0c1.223-9.21 1.544-18.707 1.919-27.989c.291-7.363-.213-16.335-5.217-22.23C38.446-4.283 22.895.53 12.669 6.136c-2.047 1.121-.217 4.246 1.827 3.125"/>
                                    <path d="M51.878 40.35a4.492 4.492 0 0 1-8.983 0v-1.655a4.492 4.492 0 1 1 8.983 0zm.432 16.07c-.344 4.068-2.029 7.242-3.771 7.096c-1.738-.146-2.868-3.566-2.524-7.626l.229-2.713c.342-4.063 2.032-7.241 3.771-7.096c1.734.149 2.87 3.566 2.524 7.626z"/></g><path fill="#25333a" d="m13.384 8.608l1.146 25.737m-.78-25.753l1.146 25.737l-.722.032l-1.146-25.737z"/></svg>
                        </div>
                        <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">Fisherman</div>
                        <span class="text-surface-700 dark:text-surface-100 text-2xl leading-normal mr-0 md:mr-2" style="max-width: 650px"
                            >Di Example Roleplay terdapat fitur memancing, anda dapat mencari ikan di pinggir pantai atau di tengah laut menggunakan kapal.</span
                        >
                    </div>

                    <div class="flex justify-end order-1 sm:order-2 col-span-12 lg:col-span-6 bg-grey-100 p-0" style="border-radius: 8px">
                        <img src="/demo/images/features/gallery2.jpg" class="w-11/12" alt="mockup" />
                    </div>
                </div>
            </div>
